<template>
    <div class="flex justify-center mb-14">
		<ul class="pagination bg-white p-0 md:p-2 shadow-sm rounded">
			...
			>
				<span
					class="rounded-sm border border-orange-100 px-2 py-1 md:px-3 md:py-2 bg-orange-100 no-underline text-orange-500 cursor-not-allowed mx-2"
					v-if="isPageActive(page.name)"
				>{{ page.name }}</span>
				<a
					class="rounded-sm border border-gray-100 px-2 py-1 md:px-3 md:py-2 hover:bg-gray-100 text-gray-600 no-underline mx-2"
					href="#"
					v-else
